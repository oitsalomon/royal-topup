        ...
        <div className="space-y-6">
            <div className="flex items-center justify-between">
                ...
                <div className="flex gap-2">
                    ...
                    <button
                        ...
                        className="px-4 py-2 bg-purple-500/10 hover:bg-purple-500/20 text-purple-400 rounded-lg text-sm font-medium transition-colors border border-purple-500/20"
                    >
                        ⇄ Transfer
                    </button>
                </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="glass p-4 rounded-xl flex items-center justify-between">
                    <div>
                        <p className="text-gray-400 text-xs font-medium uppercase tracking-wider">Total Uang (Semua Bank)</p>
                        <p className="text-2xl font-bold text-white mt-1">Rp {totalBankBalance.toLocaleString()}</p>
                    </div>
                ...
                <div className="glass p-4 rounded-xl flex items-center justify-between">
                    <div>
                        <p className="text-gray-400 text-xs font-medium uppercase tracking-wider">Total Chip (Semua Akun)</p>
                ...
                {data?.pendingCount > 0 ? (
                    <div className="bg-yellow-500/10 border border-yellow-500/20 p-4 rounded-xl flex items-center justify-between animate-pulse">
                        <div>
                            ...
                            <p className="text-2xl font-bold text-yellow-400 mt-1">{data.pendingCount} Transaksi</p>
                        </div>
                        <a href="/admin/transactions" className="px-4 py-2 bg-yellow-500 text-black text-xs font-bold rounded-lg hover:bg-yellow-400">
                            Proses
                        </a>
                    </div>
                ) : (
                    <div className="glass p-4 rounded-xl flex items-center justify-between opacity-50">
                        <div>
                            <p className="text-gray-400 text-xs font-medium uppercase tracking-wider">Status</p>
                            <p className="text-xl font-bold text-gray-300 mt-1">Semua Aman</p>
                        </div>
