            ...
            {showForm && (
                <div className="glass p-6 rounded-2xl mb-8 animate-in fade-in slide-in-from-top-4">
                    ...
                    <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div className="md:col-span-2">
                            <label className="block text-xs text-gray-400 mb-1">Nama Toko (Store Group)</label>
                            <input
                            ...
                            />
                            <p className="text-xs text-gray-500 mt-1">Digunakan untuk filter bank otomatis. Kosongkan jika General.</p>
                        </div>
