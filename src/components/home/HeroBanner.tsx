        ...
        <div className="relative pt-40 pb-32 overflow-hidden">
            ...
            <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center z-10">
                ...
                <div className="mt-12 flex flex-col sm:flex-row justify-center gap-4">
                    <a href="#games" className="group relative px-8 py-4 rounded-full bg-gradient-to-r from-emerald-500 to-green-600 text-white font-bold overflow-hidden shadow-lg shadow-emerald-500/25 hover:shadow-emerald-500/50 transition-all transform hover:-translate-y-1">
